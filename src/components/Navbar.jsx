...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-slate-100 dark:bg-slate-900 shadow-md'>
        <div className='w-14 h-14 bottom-3 p-3 text-green-800 dark:text-slate-300  font-bold text-xl z-20'>
           SR
        </div>

        {/* Menu */}
        <ul className='hidden md:flex transition-all duration-150 ease-linear'>
          <li><LinkScroll to='home' activeClass='text-green-800 dark:text-green-400 font-bold' spy={true} smooth={true} className={'dark:text-slate-300 hover:text-green-800 dark:hover:text-green-400 hover:font-bold '} >Home</LinkScroll></li>
          <li><LinkScroll to='about' activeClass='text-green-800 dark:text-green-400 font-bold' spy={true} smooth={true} className={'dark:text-slate-300 hover:text-green-800 dark:hover:text-green-400 hover:font-bold '} >About</LinkScroll></li>
          <li><LinkScroll to='skills' activeClass='text-green-800 dark:text-green-400 font-bold' spy={true} smooth={true} className={'dark:text-slate-300 hover:text-green-800 dark:hover:text-green-400 hover:font-bold '} >Skills</LinkScroll></li>
          <li><LinkScroll to='portfolio' activeClass='text-green-800 dark:text-green-400 font-bold' spy={true} smooth={true} className={'dark:text-slate-300 hover:text-green-800 dark:hover:text-green-400 hover:font-bold '} >Portfolio</LinkScroll></li>
          <li><LinkScroll to='contact' activeClass='text-green-800 dark:text-green-400 font-bold' spy={true} smooth={true} className={'dark:text-slate-300 hover:text-green-800 dark:hover:text-green-400 hover:font-bold '} >Contact</LinkScroll></li>          
        </ul>
